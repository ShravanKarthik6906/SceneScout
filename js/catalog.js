...
const NATIONWIDE = [
  ...
  {
    id: 'dogpatch-warehouse', name: 'Dogpatch Bay Warehouse', type: 'warehouse',
    neighborhood: 'Dogpatch, San Francisco', address: '901 Minnesota St, San Francisco, CA',
    lat: 37.7580, lng: -122.3890, sqft: 8200, ceilingFt: 20, rate: 340, light: 'moderate',
    tags: ['bay light', 'skylights', 'drive-in door', 'grip trucks OK'],
    desc: 'Restored shipbuilding-era warehouse two blocks from the bay, with skylights and a drive-in bay door — room for large builds, car shoots, and set pieces.',
    palette: { wall: '#8d8d94', floor: '#6e6a63', accent: '#d97b4f' }, plan: 'frogtown-warehouse',
  },
  {
    id: 'fishtown-loft', name: 'Fishtown Daylight Loft', type: 'loft',
    neighborhood: 'Fishtown, Philadelphia', address: '1300 Frankford Ave, Philadelphia, PA',
    lat: 39.9700, lng: -75.1290, sqft: 2900, ceilingFt: 13, rate: 235, light: 'abundant',
    tags: ['exposed brick', 'steel windows', 'freight elevator', 'river light'],
    desc: 'Converted textile-mill loft with steel-frame windows and exposed brick a few blocks from the Delaware — a natural-light workhorse for editorial and lookbook shoots.',
    palette: { wall: '#b8a894', floor: '#8a6f52', accent: '#e8b45a' }, plan: 'arts-district-loft',
  },
  {
    id: 'pearl-district-gallery', name: 'Pearl District White Box', type: 'gallery',
    neighborhood: 'Pearl District, Portland', address: '1120 NW Glisan St, Portland, OR',
    lat: 45.5290, lng: -122.6820, sqft: 3100, ceilingFt: 14, rate: 255, light: 'moderate',
    tags: ['white walls', 'polished concrete', 'track lighting', 'loading dock'],
    desc: 'Two connected white-box galleries in a converted warehouse block, under diffused skylights with polished concrete floors — a clean canvas for product and art direction.',
    palette: { wall: '#f0f0f0', floor: '#cacaca', accent: '#e8b45a' }, plan: 'long-beach-gallery',
  },
  {
    id: 'deep-ellum-bar', name: 'Deep Ellum Neon Bar', type: 'storefront',
    neighborhood: 'Deep Ellum, Dallas', address: '2801 Commerce St, Dallas, TX',
    lat: 32.7830, lng: -96.7810, sqft: 2000, ceilingFt: 12, rate: 225, light: 'moderate',
    tags: ['vintage neon', 'exposed brick', 'live-music stage', 'closed Mondays'],
    desc: "Working music-venue bar with original neon and a small stage in Dallas's historic entertainment district — available for stills and night interiors on dark days.",
    palette: { wall: '#6e3b3b', floor: '#31343a', accent: '#e85a7f' }, plan: 'echo-park-bar',
  },
  {
    id: 'bywater-house', name: 'Bywater Creole Cottage', type: 'house',
    neighborhood: 'Bywater, New Orleans', address: '3200 Chartres St, New Orleans, LA',
    lat: 29.9660, lng: -90.0330, sqft: 1550, ceilingFt: 11, rate: 165, light: 'abundant',
    tags: ['shotgun layout', 'wraparound porch', 'garden', 'humid haze light'],
    desc: 'Restored shotgun-style creole cottage with tall ceilings and a wraparound porch — soft, hazy Gulf light and period detail for narrative and lifestyle work.',
    palette: { wall: '#d9c8ae', floor: '#8f6b45', accent: '#7d9c6f' }, plan: 'highland-park-house',
  },
  {
    id: 'corktown-studio', name: 'Corktown Daylight Studio', type: 'studio',
    neighborhood: 'Corktown, Detroit', address: '1439 Michigan Ave, Detroit, MI',
    lat: 42.3300, lng: -83.0680, sqft: 4600, ceilingFt: 19, rate: 300, light: 'controlled',
    tags: ['white cyc', 'exposed brick shell', 'blackout', 'freight access'],
    desc: 'Full blackout stage inside a converted 1900s factory shell, with a 35-ft white cyc and dedicated freight access — built for commercial and automotive work.',
    palette: { wall: '#9aa1ad', floor: '#3d4148', accent: '#7fb4ff' }, plan: 'sunset-cyc-studio',
  },
  {
    id: 'georgetown-estate', name: 'Georgetown Federal Estate', type: 'estate',
    neighborhood: 'Georgetown, Washington, DC', address: '3211 R St NW, Washington, DC',
    lat: 38.9076, lng: -77.0723, sqft: 6200, ceilingFt: 14, rate: 460, light: 'abundant',
    tags: ['formal gardens', 'chandeliers', 'period millwork', 'ballroom'],
    desc: 'Federal-style townhouse estate with a chandeliered ballroom and boxwood gardens — period drama, formal-wear editorial, and prestige-TV ready.',
    palette: { wall: '#e6ddcc', floor: '#b49664', accent: '#a3823c' }, plan: 'pasadena-estate',
  },
  {
    id: 'arcadia-bungalow', name: 'Arcadia Desert Bungalow', type: 'house',
    neighborhood: 'Arcadia, Phoenix', address: '4515 E Indianola Ave, Phoenix, AZ',
    lat: 33.5060, lng: -111.9860, sqft: 1800, ceilingFt: 10, rate: 175, light: 'abundant',
    tags: ['citrus grove', 'desert light', 'pool', 'mountain views'],
    desc: 'Midcentury ranch under a working citrus grove with Camelback Mountain views — bright desert light all day on a quiet residential street.',
    palette: { wall: '#d8cbb4', floor: '#9c7a54', accent: '#7aa874' }, plan: 'venice-bungalow',
  },
  {
    id: 'north-park-studio', name: 'North Park Daylight Studio', type: 'studio',
    neighborhood: 'North Park, San Diego', address: '3030 University Ave, San Diego, CA',
    lat: 32.7480, lng: -117.1290, sqft: 2500, ceilingFt: 15, rate: 295, light: 'abundant',
    tags: ['cyc wall', 'coastal light', 'rolling blackout', 'client lounge'],
    desc: 'West-facing daylight studio with a hard cyc and rolling blackout a few miles from the coast — soft light all afternoon, strobes in minutes.',
    palette: { wall: '#eceff2', floor: '#cfd3d8', accent: '#5aa7e8' }, plan: 'santa-monica-studio',
  },
  {
    id: 'north-loop-warehouse', name: 'North Loop Timber Warehouse', type: 'warehouse',
    neighborhood: 'North Loop, Minneapolis', address: '212 3rd Ave N, Minneapolis, MN',
    lat: 44.9860, lng: -93.2760, sqft: 7600, ceilingFt: 21, rate: 285, light: 'moderate',
    tags: ['heavy timber', 'skylights', 'freight elevator', 'grip trucks OK'],
    desc: 'Heavy-timber flour-mill-district warehouse with bow-truss skylights — room for builds, product sets, and vehicle work near the riverfront.',
    palette: { wall: '#8d8d94', floor: '#6e6a63', accent: '#d97b4f' }, plan: 'frogtown-warehouse',
  },
];
